...
[Command]
name = "Shockwave_x"
command = ~F, D, DF, y;~F, DF, D, DB, B, x
[Command]
name = "Shockwave_y"
...
;---------------------------------------------------------------------------
;Hyper8 Huge version - not ready yet :(
...
;trigger2 = ((stateno = 0) || (stateno = 1))
;trigger3 = enemy,name!="Rogue" ;will fix this in an update
...
type = ChangeState
value = 3300
triggerall = power >= 1000 && numexplod(3701)=0 && numexplod(3301)=0
triggerall = (StateType != A) && (MoveType != H) && !Var(59)
triggerall = (!IsHelper)
triggerall = command = "Hyper5"
trigger1 = ctrl = 1

;Hyper - 4 Horsemen Attack
[State -1, 4 Horsemen Hyper]
type = ChangeState
value = 3500
triggerall = power >= 1000
triggerall = (StateType != A) && (MoveType != H) && !Var(59)
triggerall = !IsHelper
;trigger1 = ((enemy,name!="Archangel") || (enemy,name!="Sunfire") || (enemy,name!="Polaris") || (enemy,name!="Deathbird"))
trigger1 = enemy,name!="Archangel"
trigger1 = enemy,name!="Sunfire"
trigger1 = enemy,name!="Polaris"
trigger1 = enemy,name!="Deathbird"
...
value = 1200
;triggerall = !Var(59)
triggerall = stateno < 3000 && numhelper(1221) = 0  && (var(59) = 0)
...
triggerall =  (StateType = A) && (MoveType != H) && !Var(59)
triggerall =  (!IsHelper)
triggerall = (command = "Special5x") || (command = "Special5y") || (command = "Special5z")
trigger1 =  (ctrl = 1)
trigger2 = ((stateno = 600) || (stateno = 610)) && (movecontact >= 1)
trigger3 = ((stateno = 630) || (stateno = 640)) && (movecontact >= 1)
trigger4 = ((stateno = 620) || (stateno = 650)) && (movecontact >= 1)

[State -1, Jump Special7x]
type = ChangeState
value = 1630
triggerall = !Var(59)
triggerall = command = "Special3a"
...
value = 1660
triggerall = !Var(59)
triggerall = (command = "SpecialAirx") || (command = "SpecialAiry") || (command = "SpecialAirz")
trigger1 = Statetype = A && ctrl
trigger2 = (StateNo = 600) && Movecontact
...
type = ChangeState
value = IfElse(P2BodyDist X > 78,210,211)
triggerall = !Var(59)
...
[State -1, Hard Punch]
type = ChangeState
value = IfElse(P2BodyDist X > 58,220,221)
triggerall = !Var(59)
triggerall = Command = "z"
triggerall = Command != "holddown"
trigger1 = (StateType = S) && (Ctrl)
...
[State -1, Hard Kick]
type = ChangeState
value = IfElse(P2BodyDist X > 78,250,251)
triggerall = !Var(59)
...
trigger1 = command = "SJ"
trigger1 = ctrl
trigger2 = command = "SJ" || command = "holdup"
trigger2 = MoveHit
...
;type = ChangeState
;value = 210
;triggerall = Command = "SCannon" || Command = "HSCannon"
;trigger1 = ctrl
...
;type = ChangeState
;value = 225
;triggerall = Command = "Shockwave_x" || Command = "Shockwave_y" || Command = "Shockwave_z"
;trigger1 = ctrl
