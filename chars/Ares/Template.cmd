...
[State -1, standGuard]
type = ChangeState
triggerall = var(59) && (P2StateType != C) && (P2MoveType = A)
triggerall =(StateType != A) && (Ctrl)&& (enemynear, Facing != Facing) 
trigger1 = random <= 600 && numexplod(3202)=0
trigger2 =  random <= 200 && numexplod(3202)=1
;trigger2 = inguarddist  
value = 130

[State -1, airGuardHitBack]
type = ChangeState
triggerall = var(59) && StateNo = 150
...
[State -1, airGuard]
type = ChangeState
triggerall = var(59) && P2MoveType = A
triggerall = (StateType = A) && (Ctrl) && (enemynear, Facing != Facing) 
trigger1 =  random <= 600 && numexplod(3202)=0
trigger2 =  random <= 200 && numexplod(3202)=1
;trigger2 = inguarddist  
...
type = ChangeState
value = 3000
triggerall = power >= 1000 && var(59) && ctrl && p2bodydist x < 160
triggerall = StateType != A && MoveType != H && RoundState = 2 && enemynear, statetype != A
...
trigger1 = enemynear, statetype = A && p2bodydist x < 50 && random < 400
trigger2 = enemynear, statetype != A && p2bodydist x > 150 && random < 150

[State -1, megaBeam]
type = ChangeState
value = 3200
triggerall = power >= 1000 && var(59) && ctrl && p2bodydist x > 100 && numexplod(3202)=0
triggerall = StateType != A && MoveType != H && RoundState = 2
...
type = ChangeState
value = 1000
triggerall = var(59) && ctrl && p2bodydist x > 60
triggerall = StateType != A && MoveType != H && RoundState = 2 && enemynear, statetype != A
...
type = ChangeState
value = 1010
triggerall = var(59) && ctrl && p2bodydist x > 160
triggerall = StateType != A && MoveType != H && RoundState = 2 && enemynear, statetype = A
trigger1 = enemynear, numproj = 0 && enemynear, movetype != A && random < 100
...
type = ChangeState
value = 1200
triggerall = var(59) && ctrl && p2bodydist x > 180
triggerall = StateType != A && MoveType != H && RoundState = 2
trigger1 = enemynear, numproj = 0 && enemynear, movetype != A && random < 100
...
type = ChangeState
value = 100
triggerall = var(59) && RoundState = 2 && ctrl  && random < 200 && prevstateno != 100
triggerall = (statetype = S) && enemynear, p2dist X >= 75
triggerall = Var(20) != 3 && NumHelper(25) = 0 && p2bodydist x > 75
trigger1 = enemynear, movetype != A &&  enemynear, statetype != L
...
type = ChangeState
value = 3200
triggerall = power >= 1000 && numexplod(3202)=0
triggerall = (StateType != A) && (MoveType != H) && !Var(59)
triggerall = (ctrl = 1) && (!IsHelper)
...
trigger3 = stateno = 250 && movehit && command="holdup"
